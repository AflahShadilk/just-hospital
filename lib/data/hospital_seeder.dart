    ...
    try {
      final hospitals = <String, Map<String, dynamic>>{
        'aster_mims': {
          ...
          'imageUrl':
              'assets/hospitals/MIMS_Kozhikode.jpg',
          'rating': 0,
          'specialisations': [
            'Cardiology',
            'Neurosciences',
        ...
        'baby_memorial': {
          ...
          'imageUrl':
              'assets/hospitals/baby memorial.jpg',
          'rating': 0,
          'specialisations': [
            'Cardiology',
            'Oncology',
        ...
        'iqraa': {
          ...
          'imageUrl':
              'assets/hospitals/iqraa-international-hospital-research-centre-kozhikode-hospitals-qkm0gajy77.avif',
          'rating': 0,
          'specialisations': [
            'Cardiology',
            'Nephrology',
        ...
        'meitra': {
          ...
          'imageUrl':
              'assets/hospitals/meitra hospital.jpg',
          'rating': 0,
          'specialisations': [
            'Heart & Vascular',
            'Bone Joint & Spine',
        ...
        'starcare': {
          ...
          'imageUrl':
              'assets/hospitals/starcare hospital.jpg',
          'rating': 0,
          'specialisations': [
            'Cardiology',
            'Orthopaedics',
        ...
        'malabar': {
          ...
          'imageUrl':
              'assets/hospitals/malabar hospital.jpg',
          'rating': 0,
          'specialisations': [
            'Urology',
            'Oncology',
        ...
        'fathima': {
          ...
          'imageUrl':
              'assets/hospitals/fathima hospital.jpg',
          'rating': 0,
          'specialisations': [
            'Cardiology',
      ...
      debugPrint('================================');
      debugPrint('HOSPITAL SEED SUCCESSFUL');
      debugPrint('8 HOSPITALS ADDED TO FIRESTORE');
      debugPrint('================================');
    } catch (error, stackTrace) {
      debugPrint('================================');
      debugPrint('HOSPITAL SEED FAILED');
